...
pHred = 0.4
pH,CO2_IE_a,HCO3_IE,CO3_IE = Cchem(14,2191,34,1025.442,8.34-pHred)
pH,CO2_PU_s_a,HCO3_PU_s,CO3_PU_s = Cchem(13.8,2191,33,1024.711,8.07-pHred)
pH,CO2_PU_l_a,HCO3_PU_l,CO3_PU_l = Cchem(13.5,2191,33,1024.772,8.28-pHred)

st([["CO2 (uM)",CO2_IE_a,CO2_PU_s_a,CO2_PU_l_a],\
    ["HCO3 (uM)",HCO3_IE,HCO3_PU_s,HCO3_PU_l],\
    ["CO3 (uM)",CO3_IE,CO3_PU_s,CO3_PU_l]],"","Output_low_pH")

w=0.4
x = ['IE','PU (Short)','PU (Long)']
bar1 = arange(len(x))
bar2 = [i+w for i in bar1] 
Before = [CO2_IE,CO2_PU_s,CO2_PU_l]
After = [CO2_IE_a,CO2_PU_s_a,CO2_PU_l_a]
